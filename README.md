...
> ⚠️ PyTorch 2.8 is listed in requirements. Install the correct CUDA version for your GPU from [pytorch.org](https://pytorch.org/get-started/locally/) if needed.
...
Or download manually from the [Releases](../../releases) page and place in `disease_detection_model/`.
